...
var db = require('./models/models.js').db;
var Place = require('./models/models.js').Place;
var Hotel = require('./models/models.js').Hotel;
var Restaurant = require('./models/models.js').Restaurant;
var Activity = require('./models/models.js').Activity;
